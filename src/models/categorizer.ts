...
export class Categorizer {
  ...
  private checkDynamicBlocklist(domain: string): CategoryResult {
  ...
  private queryCloudflareRadar(domain: string): Promise<CategoryResult> {
  ...
  private checkDomainReputation(domain: string): Promise<CategoryResult> {
    return new Promise((resolve) => {
      const options = {
        hostname: 'dns.google',
  ...
  private categorizeByReputation(domain: string, dnsData: any): { category: string; confidence: number; isBlocked: boolean } {
